...
/// Manages the shopping cart, persisted in Sqflite through [CartRepository].
/// Every mutation writes to the database first, then reloads state so the
/// UI and storage stay in sync.
